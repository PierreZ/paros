// Re-exports of the generated contract.
//
// `src/generated/` is written by `cargo test -p paros-play` and is never
// hand-edited; this file is the one import path the rest of the app uses, so a
...
export type { ChosenView } from './generated/ChosenView';
export type { ClientView } from './generated/ClientView';
export type { ElectionView } from './generated/ElectionView';
...
export type { WorldView } from './generated/WorldView';
